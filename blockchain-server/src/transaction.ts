...
class UnspentTxOut {
    ...
    public readonly accountFrom: {
        id: number,
        idbank: number
    };
    public readonly accountTo: {
        id: number,
        idbank: number
    };
    constructor(txOutId: string, txOutIndex: number, address: string, amount: number, accountFrom, accountTo) {
...
class TxOut {
    ...
    constructor(address: string, amount: number, accountFrom, accountTo) {
        this.address = address;
        this.amount = amount;
        this.accountFrom = accountFrom;
        this.accountTo = accountTo;
...
const updateUnspentTxOuts = (aTransactions: Transaction[], aUnspentTxOuts: UnspentTxOut[]): UnspentTxOut[] => {
    const newUnspentTxOuts: UnspentTxOut[] = aTransactions
        .map((t) => {
            ...
            return t.txOuts.map((txOut, index) => new UnspentTxOut(t.id, index, txOut.address, txOut.amount,txOut.accountFrom, txOut.accountTo));
        })
